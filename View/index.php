...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                <div class="d-flex">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="inscription.view.php">Connexion</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <main>
        <div id="carouselExampleCaptions" style="height: 500px;"class="carousel slide w-100" data-mdb-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active d-flex justify-content-center">
                    <img src="../img/ECYW0642.JPG" class="d-block" style="height: 500px;width: 1050;" alt="Wild Landscape" />
